...
**Requirements**: We are using `node V20.11.1` and `npm 10.2.4`. They can be downloaded via [installer](https://nodejs.org/en). For more information check [here](https:/npm/docs.npmjs.com/downloading-and-installing-node-js-and-npm)
